...
const NUM_TIMESTEPS_CHART = {"type":"line","data":{"datasets":[{"label":"40","data":[{"x":0.19992318333333334,"y":23.563398328795717},{"x":5.298536549999999,"y":2.6900922928377766},{"x":10.363278316666667,"y":2.5887286975499615},{"x":20.369152733333333,"y":2.552794727908588},{"x":25.372502383333334,"y":2.560049428596592},{"x":30.41839483333333,"y":2.538659702253124},{"x":35.37642478333333,"y":2.538748069019333},{"x":40.423945783333316,"y":2.5291915780539185},{"x":45.3803614833333,"y":2.516153947073198},{"x":50.431366849999975,"y":2.5175249209869115},{"x":55.384447416666646,"y":2.533293451100014},{"x":60.43554894999999,"y":2.524153959718847}],"borderColor":"#BBDEFB","backgroundColor":"#BBDEFB"},{"label":"80","data":[{"x":0.22673986666666668,"y":23.476603119310997},{"x":5.324792033333334,"y":2.5469323531325405},{"x":10.330454499999997,"y":2.4130154995598496},{"x":15.332722400000002,"y":2.3871061832072713},{"x":20.33348743333334,"y":2.3430465775392855},{"x":25.33679925,"y":2.401207744770809},{"x":30.339955683333322,"y":2.364456287808552},{"x":35.34356411666666,"y":2.354917524968619},{"x":40.34644784999997,"y":2.3548248087969714},{"x":45.352850699999976,"y":2.347399846674302}],"borderColor":"#64B5F6","backgroundColor":"#64B5F6"},{"label":"120","data":[{"x":0.17053681666666665,"y":23.541265656988113},{"x":5.137036283333334,"y":2.611546069603357},{"x":10.14529945,"y":2.4154654164406124},{"x":15.152396566666662,"y":2.3157104822958945},{"x":20.156820133333326,"y":2.2995096910973456},{"x":25.166208100000002,"y":2.298192583173649},{"x":30.169406433333332,"y":2.296125546578923},{"x":35.17047406666667,"y":2.2863630577088},{"x":40.17559681666666,"y":2.2851251906190995},{"x":45.184890816666645,"y":2.2998340631551493}],"borderColor":"#1565C0","backgroundColor":"#1565C0"},{"label":"160","data":[{"x":0.16784925,"y":23.516829844844295},{"x":5.133964916666666,"y":2.740058121841804},{"x":10.138986283333333,"y":2.398609289120548},{"x":15.141587916666667,"y":2.3034779131930825},{"x":20.14759746666666,"y":2.27510420723427},{"x":25.15096293333333,"y":2.338434247228364},{"x":30.157428483333337,"y":2.2736422582480604},{"x":35.161820500000005,"y":2.2585404683101005}],"borderColor":"#133270","backgroundColor":"#133270"}]},"options":{"scales":{"xAxes":[{"type":"linear","position":"bottom","scaleLabel":{"display":true,"labelString":"Training Time [min]"}}],"yAxes":[{"type":"logarithmic","ticks":{"min":2.2585404683101005,"max":23.563398328795717},"scaleLabel":{"display":true,"labelString":"Validation Perplexity"}}]}}};
const ALL_CHARTS = [BATCH_SIZE_DECAY_CHART, LEARNING_RATE_FIRST_CHART, NUM_TIMESTEPS_CHART];
...
const NUM_TIMESTEPS_EPOCH_MINUTES = {
    '40': 1.35,
    '80': 1.28,
    '120': 1.28,
    '160': 1.28
...
function plotNumTimestepsEpochDuration() {
    let labels = Object.keys(NUM_TIMESTEPS_EPOCH_MINUTES).sort((a, b) => parseInt(a) - parseInt(b));
    let values = labels.map(l => NUM_TIMESTEPS_EPOCH_MINUTES[l]);
    let colors = labels.map(l => NUM_TIMESTEPS_COLORS[l]);
    new Chart('num-timesteps-epoch-duration-chart', {
        type: 'horizontalBar',
        data: {
            labels: labels,
            datasets: [{
